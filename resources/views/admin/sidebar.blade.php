                ...
                <ul class="metismenu" id="menu1">
                    <li>
                        <a class="has-arrow" href="#" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i>
                            <span class="mini-click-non">Pekerjaan</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Lihat Pekerjaan" href="/admin/lihat-pekerjaan"><span
                                        class="mini-sub-pro">Lihat
                                        Pekerjaan</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Lihat Transaksi" href="/admin/lihat-transaksi"><span
                                        class="mini-sub-pro">Lihat
                                        Transaksi</span></a></li>
                            <li><a title="Cetak Laporan" href="/admin/cetak-transaksi"><span class="mini-sub-pro">Cetak
                                        Laporan</span></a></li>
                        </ul>
                    </li>
                    <li>
